...
You can install this plugin using the ALLPLAN Plugin Manager.

Alternatively download the `.allep` package from the [release page](https://github.com/bmarciniec/fixture-placement/releases).
In this case make sure to download the right release for your ALLPLAN version.

The plugin contains one PythonPart _Fixture placement_. It can be run from the ALLPLAN Library:

_Private_ -> _Allplan GmbH_ -> Fixture placement

> [!NOTE]
> The PythonPart is also available in the **Actionbar Configuration** under the _Plugins_.
> This means, that you can place it wherever you want on your Actionbar and also
> assign a shortcut to the command.
> ![Actionbar configuration](./docs/assets/ActionbarConfiguration.png)
